...
def parse_sse_events_from_byte_buffer(
    ...
    Operates on bytes; only decodes complete events as UTF-8. Invalid bytes
    are replacement-decoded because this parser feeds optional usage and
    diagnostics and must not terminate an already-forwarded stream.
    """
